...
public:
	...
	//setters
	inline void SetPosition(glm::vec3 newPos) { m_isDirty = true; m_position = newPos; }
	inline void AddPosition(glm::vec3 deltaPos) { m_isDirty = true; m_position += deltaPos; }
	inline void SetRotation(glm::quat newRotation) { m_isDirty = true; m_rotation = newRotation; }
